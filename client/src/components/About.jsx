        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto">
              To deliver English learning that's truly <span className="font-bold text-blue-600">R.I.C.H.</span> for every Korean and Chinese student:
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-xl text-gray-600 mb-8">
                To be a place of growth for both teachers and students across generations.
              </p>
              <div className="space-y-4">
                <div className="flex items-center">
                  <HeartIcon className="w-6 h-6 text-red-500 mr-3" />
                  <span className="text-gray-700">Kindness-first approach to learning</span>
                </div>
                <div className="flex items-center">
                  <GlobeAltIcon className="w-6 h-6 text-blue-500 mr-3" />
                  <span className="text-gray-700">Global community of learners</span>
                </div>
                <div className="flex items-center">
                  <AcademicCapIcon className="w-6 h-6 text-green-500 mr-3" />
                  <span className="text-gray-700">Continuous growth and development</span>
                </div>
                <div className="flex items-center">
                  <HandThumbUpIcon className="w-6 h-6 text-purple-500 mr-3" />
                  <span className="text-gray-700">Interactive and engaging lessons</span>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Certified educators with years of experience</p>
                  </div>
                </div>
                <div className="flex items-start">
                  <UsersIcon className="w-6 h-6 text-blue-500 mr-3 mt-1" />
                  <div>
                    <h4 className="font-bold text-gray-900">Diverse Community</h4>
                    <p className="text-gray-600">Students from Korea and China learning together</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Track record of student success and growth</p>
                  </div>
                </div>
              </div>
            </div>
