...
const Layout = () => {
  ...
  const getNavigation = () => {
    const baseNavigation = [
      ...
      { name: 'Students', href: '/portal/students', icon: UserGroupIcon },
    ...
    if (state.teacher?.role === 'admin') {
      baseNavigation.splice(1, 0, { name: 'Teachers', href: '/portal/teachers', icon: UserGroupIcon });
    }
        ...
        <div className="relative flex-1 flex flex-col max-w-xs w-full bg-white">
          ...
          <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
            <div className="flex items-center">
              <div className="ml-3">
                <p className="text-base font-medium text-gray-700">{state.teacher?.name}</p>
                <button
            ...
            <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
              <div className="flex items-center w-full">
                <div className="ml-3 flex-1">
                  <p className="text-sm font-medium text-gray-700">{state.teacher?.name}</p>
                  <button
                    onClick={handleLogout}
