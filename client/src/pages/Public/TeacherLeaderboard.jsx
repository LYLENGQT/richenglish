...
const TeacherLeaderboard = () => {
  ...
  const mockLeaderboard = [
    ...
    },
    {
      ...
      picture: "https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?w=150&h=150&fit=crop&crop=face",
      totalClasses: 115,
      attendanceRate: 92.5,
      studentFeedback: 4.3,
      responsiveness: 80,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">Communication and engagement quality</p>
            </div>
          </div>
        </div>
      </section>
                    ...
                    <tr key={teacher.id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <div className={`w-8 h-8 rounded-full flex items-center justify-center text-white font-bold ${
                            teacher.rank <= 3 ? getBadgeColor(teacher.badge) : 'bg-gray-400'
                          }`}>
                            {teacher.rank <= 3 && (
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          ...
                          <span className="text-sm text-gray-900">{teacher.attendanceRate}%</span>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          <StarIcon className="w-4 h-4 text-yellow-400 fill-current mr-1" />
                          <span className="text-sm text-gray-900">{teacher.studentFeedback}</span>
                        </div>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex items-center">
                          ...
                          <span className="text-sm text-gray-900">{teacher.responsiveness}%</span>
                        </div>
                      </td>
                    </tr>
                  ))}
